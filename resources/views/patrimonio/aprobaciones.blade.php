...
<x-app-layout> {{-- ¡CAMBIO AQUÍ! --}}
  <x-slot name="header">
    <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
        {{ __('Aprobaciones de Patrimonio') }} {{-- O el título que desees --}}
    </h2>
  </x-slot>

  {{-- Aquí iría todo el contenido existente de tu vista de aprobaciones --}}
  {{-- Por ejemplo: --}}
  <x-ui.section-title title="Aprobaciones de Patrimonio" subtitle="Gestiona los movimientos pendientes de aprobación" />
